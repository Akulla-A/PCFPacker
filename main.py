# Variables
dirScan = "C:/PATH/TO/A/FOLDER/WITH/YOUR/PCF FILES INSIDE/"
...
# Create a vmf file, you can compile afterwards with VIDE
models, textures = [], []
...
with open(dirVMF, 'w', encoding='utf-8') as f:
...
""")
    ...
    f.write(vmfFile)
    print(f"VMF file '{dirVMF}' created successfully.")